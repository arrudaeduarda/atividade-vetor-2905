...
public class ExemploArraylist2905 {
	...
	public static void main(String[] args) {
		...
		numeros.set(1, 25);
		System.out.println(numeros.get(1)); // Saída: 25 // Modificando o elemento do ArrayList

		numeros.remove(0);
		System.out.println(numeros.get(0)); // Saída: 25 // Removendo o elemento do ArrayList
